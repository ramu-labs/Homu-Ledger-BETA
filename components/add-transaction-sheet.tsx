  ...
  return (
    <>
      ...
      <div
        ref={sheetRef}
        className={cn(
          "fixed bottom-0 left-1/2 z-[70] w-full max-w-md -translate-x-1/2 h-[100lvh] min-h-screen flex flex-col rounded-t-3xl bg-[var(--surface)] overflow-x-hidden [touch-action:pan-y]",
